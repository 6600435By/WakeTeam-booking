...
export async function GET(_req: Request, context: RouteContext) {
  try {
    ...
    console.error(e);
    return NextResponse.json({ error: "Ошибка статуса восстановления", hint: "Обновите страницу и повторите действие. Если ошибка повторяется — перелогиньтесь или обратитесь к администратору." }, { status: 500 });
  }
}
