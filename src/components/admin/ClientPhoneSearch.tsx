...
export function ClientPhoneSearch({ branchId, onOpenAppointment }: Props) {
  ...
  return (
    <div className="relative w-full sm:w-auto sm:min-w-[220px]">
      ...
      {open && isSearchablePhone(phone) && result && (
        <>
          <button
            type="button"
          ...
          />
          <div className="absolute right-0 z-50 mt-2 w-[min(100vw-2rem,28rem)] rounded-xl border border-slate-200 bg-white p-4 shadow-lg">
            {showClientPicker ? (
              <>
